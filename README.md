...
helm upgrade --install myrelease myapp-helm --namespace='myapp' --set-string appspa.image.repository='valdaakssec001.azurecr.io/myappspa',appspa.image.tag='v1',apptodo.image.repository='valdaakssec001.azurecr.io/myapptodo',apptodo.image.tag='v1',apphost='40.113.68.126.xip.io'
